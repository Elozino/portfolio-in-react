    ...
    return (
      <main>
        <div className="main-body">
          ...
          <p>
            I am a front-end developer who loves bringing life to aesthetics. A
            tech enthusiast with curiosity to problem analysis and solving
            through learning, unlearning, and relearning. I am open to offers
            and would love to work on products that bring value.
          </p>
          <a
